...
export const env = createEnv({
  server: {
    ...
    AI_COMMENT_CRON_SECRET: z.string().optional(),
    ...
    RATELIMIT_AUTH_VERIFY_PER_HOUR: z.coerce.number().optional(),
    RATELIMIT_AUTH_RESEND_PER_HOUR: z.coerce.number().optional(),
    RATELIMIT_AUTH_FORGOT_PER_HOUR: z.coerce.number().optional(),
  ...
  client: {
    ...
    NEXT_PUBLIC_FEATURE_MEAL_PLANS: z
      .string()
      .optional()
  ...
  runtimeEnv: {
    ...
    AI_COMMENT_CRON_SECRET: process.env.AI_COMMENT_CRON_SECRET,
    ...
    RATELIMIT_AUTH_VERIFY_PER_HOUR: process.env.RATELIMIT_AUTH_VERIFY_PER_HOUR,
    RATELIMIT_AUTH_RESEND_PER_HOUR: process.env.RATELIMIT_AUTH_RESEND_PER_HOUR,
    RATELIMIT_AUTH_FORGOT_PER_HOUR: process.env.RATELIMIT_AUTH_FORGOT_PER_HOUR,
    ...
    NEXT_PUBLIC_FEATURE_MEAL_PLANS: process.env.NEXT_PUBLIC_FEATURE_MEAL_PLANS,
  },
